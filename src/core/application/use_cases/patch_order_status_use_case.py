...
from src.core.application.use_cases.dtos.order_dtos import OrderDTO, OrderStatusUpdateDTO
from src.core.application.exceptions.not_found_exception import NotFoundException


class PatchOrderStatusUseCase:
    def __init__(self, order_repo: OrderRepository):
        self.order_repo = order_repo
    
    async def execute(self, create_order_input_dto: OrderStatusUpdateDTO) -> OrderDTO:
        ...
        order_entity.change_status(new_status=create_order_input_dto.status)
